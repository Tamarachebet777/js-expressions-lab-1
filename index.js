...
function tot_temperature_in_fahrenheit(){
    return tempF.reduce((sum, t) => sum + t, 0);
}

// sum of all tempreaature in celcius
function tot_temperature_in_celsius(){
    return tempC.reduce((sum, t) => sum + t, 0);
}

// calculate average temperature in fahrenheit
function avg_temperature_in_fahrenheit(){
    return tot_temperature_in_fahrenheit() / tempF.length;
}

// calculate average temperature in celius
function avg_temperature_in_celsius(){
    return tot_temperature_in_celsius() / tempC.length;
}
